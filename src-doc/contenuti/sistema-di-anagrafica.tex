...
DatabaseService si occupa di effettuare tutte le operazioni di connessione e interazione con il database; in questo modo viene rispettato il principio di responsabilità singola.
